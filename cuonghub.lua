...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>Premium Hack<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Cuong Hub!!!<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Cày Thuê Ib Tiktok @CuongHub<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>TikTok : @CuongHub <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Cuong Hub", HidePremium = false, IntroText = "CuongHub Library", SaveConfig = true, ConfigFolder = "Cuong Hub"})
...
OrionLib:MakeNotification({
	Name = "Cuong Hub",
	Content = "Cuong Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("[+] Cuong Hub is back!")
W:AddLabel("[+] I Not Skidder!")
W:AddLabel("[+] I @cuonghub")
W:AddLabel("[+] Load Script!")
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel()
...
if World2 and World1 then
    ...
    M:AddParagraph("Nhập code","Click vào bên dưới để nhập tất cả code x2 exp.")
...
TweenChest = M:AddToggle({
    ...
    M:AddToggle({
        Name = "Auto Chest[Tỉ lệ reset acc cao]",
        Default = false,
...
local EliteProgress = M:AddLabel("")
    ...
    M:AddToggle({
        ...
        M:AddToggle({
            Name = "Auto đánh hải tặc pháo đài",
            Default = false,
            Flag = "Auto Castle",
            Save = true,
            Callback = function(Value)
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("đây là tự động đánh hình nộm")
...
SV:AddToggle({
	Name = "Hop Tìm server trăng 3/4 or 4/4",
	Default = false,
    Flag = "FindFM",
    Save = true,
	Callback = function(Value)
...
R:AddToggle({
    Name = "Auto bật tộc v4",
    Default = false,
    Flag = "Auto bật tộc v4",
    Save = true,
    Callback = function(Value)
        _G.V4 = Value
    end    
...
R:AddButton({
    Name = "Teleport đến chỗ lắp gear",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        wait(.1)
...
R:AddToggle({
    Name = "Auto Win trials tộc",
    Default = false,
    Flag = "Auto Win Trials",
    Save = true,
    Callback = function(Value)
    ...
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                ...
                OrionLib:MakeNotification({
                    Name = "Cuong Hub(Noitification)",
                    Content = "[VN] : hủy bỏ nhiệm vụ farrm level(nếu có)",
                    Image = "rbxassetid://4483345998",
                    Time = 9
                })
            end
